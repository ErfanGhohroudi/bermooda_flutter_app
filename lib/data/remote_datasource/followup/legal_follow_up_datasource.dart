...
class LegalFollowUpDatasource implements IFollowUpDatasource {
  ...
  void create({
    ...
    try {
      final response = await _apiClient.post(
        "/v1/ContractBoard/MainContractTrackingManager/Create/",
        data: {
          "contract_case_id": sourceId,
  ...
  void update({
    ...
    try {
      final response = await _apiClient.put(
        "/v1/ContractBoard/MainContractTrackingManager/$slug/",
        data: {
  ...
  void changeTimerStatus({
    ...
    try {
      final response = await _apiClient.put(
        "/v1/ContractBoard/ContractTrackingTimerManager/$slug/",
  ...
  void changeStatus({
    ...
    try {
      final response = await _apiClient.put(
        "/v1/ContractBoard/MainContractTrackingManager/$slug/IsSuccessFull/",
  ...
  void restore({
    ...
    try {
      final response = await _apiClient.post(
        "/v1/ContractBoard/MainContractTrackingManager/$slug/Restore/",
        skipRetry: !withRetry,
      );
