...
import '../../../theme.dart';
import '../../widgets.dart';
import 'labels_dropdown_multi_select_controller.dart';

/// Just for labels that have id
class WLabelsMultiSelectFormField extends StatefulWidget {
  const WLabelsMultiSelectFormField({
  ...
  @override
  State<WLabelsMultiSelectFormField> createState() => _WLabelsMultiSelectFormFieldState();
}

class _WLabelsMultiSelectFormFieldState extends State<WLabelsMultiSelectFormField> with LabelsMultiSelectController {
  @override
  void initState() {
    super.initState();
    ...
    getLabels(widget.sourceId, widget.dataSourceType);
  }

  @override
  void didUpdateWidget(covariant final WLabelsMultiSelectFormField oldWidget) {
                              ...
                              return Theme(
                                ...
                                child: CheckboxListTile(
                                  ...
                                  title: Row(
                                    ...
                                    children: [
                                      Flexible(
                                        child: WLabel(text: label.title ?? '', color: label.colorCode.toColor()),
                                      ),
