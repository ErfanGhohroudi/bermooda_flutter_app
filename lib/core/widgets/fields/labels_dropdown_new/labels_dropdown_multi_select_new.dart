...
import '../../../theme.dart';
import '../../widgets.dart';
import 'labels_dropdown_multi_select_controller_new.dart';

/// Just for labels that have slug
class WLabelsMultiSelectFormFieldNew extends StatefulWidget {
  const WLabelsMultiSelectFormFieldNew({
  ...
  @override
  State<WLabelsMultiSelectFormFieldNew> createState() => _WLabelsMultiSelectFormFieldNewState();
}

class _WLabelsMultiSelectFormFieldNewState extends State<WLabelsMultiSelectFormFieldNew> with LabelsMultiSelectController {
  @override
  void initState() {
    ...
    getLabels(widget.sourceId);
    super.initState();
  }

  @override
  void didUpdateWidget(covariant final WLabelsMultiSelectFormFieldNew oldWidget) {
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...widget.availableLabels.map((final label) {
                              final isSelected = _tempSelectedLabels.any((final e) => e.slug == label.slug);
                              return Theme(
                                data: ThemeData(
                                  ...
                                  onChanged: (final value) {
                                    setState(() {
                                      if (value == true) {
                                        ...
                                        _tempSelectedLabels.removeWhere((final e) => e.slug == label.slug);
                                      }
                                    });
                                  },
                                ),
