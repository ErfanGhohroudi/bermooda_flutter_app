...
import 'archived_legal_departments_controller.dart';

class ArchivedLegalDepartmentsPage extends StatefulWidget {
  const ArchivedLegalDepartmentsPage({
    super.key,
  });

  @override
  State<ArchivedLegalDepartmentsPage> createState() => _ArchivedLegalDepartmentsPageState();
}

class _ArchivedLegalDepartmentsPageState extends State<ArchivedLegalDepartmentsPage> {
  late final ArchivedLegalDepartmentsController ctrl;

  @override
  void initState() {
    super.initState();
    ctrl = Get.put(ArchivedLegalDepartmentsController());
  }
          ...
          ? (final context) => WMoreButtonIcon(
              items: [
                WPopupMenuItem(
                  ...
                  onTap: () => ctrl.restoreDepartment(department.id),
                ),
              ],
            )
          : null,
