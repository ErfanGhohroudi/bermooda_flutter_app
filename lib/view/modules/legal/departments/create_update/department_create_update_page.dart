...
class LegalDepartmentCreateUpdatePage extends StatefulWidget {
  const LegalDepartmentCreateUpdatePage({
    this.department,
    super.key,
  });
  ...
  @override
  State<LegalDepartmentCreateUpdatePage> createState() => _LegalDepartmentCreateUpdatePageState();
}

class _LegalDepartmentCreateUpdatePageState extends State<LegalDepartmentCreateUpdatePage> with LegalDepartmentCreateUpdateController {
  @override
  void initState() {
