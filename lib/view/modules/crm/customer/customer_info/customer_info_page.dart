              ...
              children: [
                ...
                if (!ctrl.customer.value.socialMediaLink.isNullOrEmpty())
                  item(
                    ...
                    value: (ctrl.customer.value.socialMediaLink?.isURL ?? false)
                        ? null
                        : ctrl.customer.value.socialMediaLink ?? '- -',
                ...
                if (!ctrl.customer.value.landline.isNullOrEmpty())
                  item(
                    ...
                    child: WTextButton2(
                      text:
                          "${ctrl.customer.value.landline?.trim()}"
                ...
                if (agentInfoNotEmpty()) ...[
                  ...
                  if (!ctrl.customer.value.agentLandline.isNullOrEmpty())
                    item(
                      ...
                      child: WTextButton2(
                        text:
                            "${ctrl.customer.value.agentLandline?.trim()}"
            ...
            body: Column(
              ...
              children: [
                if (additionalInfoNotEmpty()) ...[
                  if (ctrl.customer.value.personalType == AuthenticationType.person &&
                      !ctrl.customer.value.nationalCode.isNullOrEmpty())
                    item(
                      title: s.nationalID,
                  ...
                  if (ctrl.customer.value.personalType == AuthenticationType.legal &&
                      !ctrl.customer.value.companyNationalCode.isNullOrEmpty())
                    item(
                      title: s.companyNationalID,
                      value: ctrl.customer.value.companyNationalCode,
                    ),
                  if (ctrl.customer.value.personalType == AuthenticationType.legal &&
                      !ctrl.customer.value.economicCode.isNullOrEmpty())
                    item(
