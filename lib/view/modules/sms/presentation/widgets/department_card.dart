...
import '../sheets/sms_department_main_sheet.dart';

class WSmsDepartmentCard extends StatefulWidget {
  const WSmsDepartmentCard({
  ...
  @override
  State<WSmsDepartmentCard> createState() => _WSmsDepartmentCardState();
}

class _WSmsDepartmentCardState extends State<WSmsDepartmentCard> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant final WSmsDepartmentCard oldWidget) {
    ...
    return WCard(
      ...
      onTap:
          ...
          () {
            ...
            bottomSheet(
              child: SmsDepartmentMainSheet(department: widget.department),
            );
          },
      child: Column(
