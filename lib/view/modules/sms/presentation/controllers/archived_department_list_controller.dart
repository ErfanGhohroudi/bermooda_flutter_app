...
class SmsArchivedDepartmentListController extends GetxController {
  ...
  void restoreDepartment(final SmsDepartment department) {
    appShowYesCancelDialog(
      ...
      onYesButtonTap: () async {
        ...
        try {
          ...
          departments.refresh();
          if (Get.isRegistered<SmsDepartmentListController>()) {
            Get.find<SmsDepartmentListController>().onRefresh();
          }
        } catch (e) {
