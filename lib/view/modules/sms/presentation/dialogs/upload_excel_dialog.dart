...
Future<MainFileReadDto?> uploadExel({
  required final MainFileReadDto file,
}) async {
  final UploadFileDatasource uploadFileDatasource = Get.find<UploadFileDatasource>();
  Rx<double> progress = 0.0.obs;
  RxBool isError = false.obs;

  void upload(final BuildContext context) => uploadFileDatasource.uploadFile(
    file: file,
    onProgress: (final _progress) => progress(_progress * 100),
    onFileUploaded: (final result) => delay(1000, () {
  ...
  final MainFileReadDto? result = await showDialog<MainFileReadDto>(
                ...
                return Column(
                  ...
                  children: [
                    ...
                    UElevatedButton(
                      title: s.cancel,
                      backgroundColor: context.theme.hintColor,
                      onTap: () => uploadFileDatasource.cancelUpload(),
                    ),
                  ],
                );
              },
