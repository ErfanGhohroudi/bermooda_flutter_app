...
class VoipDepartmentListController extends GetxController {
  ...
  void archiveDepartment(final VoipDepartment department) {
  ...
  Future<VoipDepartment?> createDepartment({
    ...
    try {
      final VoipDepartment department = await _createDepartmentUseCase(
        title: title,
        members: members,
        avatar: avatar,
      );
  ...
  void insertDepartment(final VoipDepartment newDepartment) {
