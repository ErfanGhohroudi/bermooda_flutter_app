...
class VoipArchivedDepartmentListPage extends StatefulWidget {
  const VoipArchivedDepartmentListPage({super.key});

  @override
  State<VoipArchivedDepartmentListPage> createState() => _VoipArchivedDepartmentListPageState();
}

class _VoipArchivedDepartmentListPageState extends State<VoipArchivedDepartmentListPage> {
  final VoipArchivedDepartmentListController ctrl = Get.put(VoipArchivedDepartmentListController());
