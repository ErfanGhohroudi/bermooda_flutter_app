...
class VoipDepartmentListPage extends StatefulWidget {
  const VoipDepartmentListPage({super.key});

  @override
  State<VoipDepartmentListPage> createState() => _VoipDepartmentListPageState();
}

class _VoipDepartmentListPageState extends State<VoipDepartmentListPage> {
  final VoipDepartmentListController ctrl = Get.put(VoipDepartmentListController());
            ...
            Obx(
              () => ctrl.haveAdminAccess && !ctrl.isReorderEnabled.value
                  ? IconButton(
                      ...
                      onPressed: () {
                        AppNavigator.push(const VoipArchivedDepartmentListPage());
                      },
                    )
            ...
            ? FloatingActionButton(
                ...
                onPressed: () {
                  bottomSheet(
                    ...
                    child: VoipDepartmentCreateUpdatePage(ctrl: ctrl),
                  );
                },
                            ...
                            SliverPadding(
                              ...
                              sliver: SliverReorderableList(
                                ...
                                onReorder: (final oldIndex, newIndex) {
                                  ...
                                  final VoipDepartment item = ctrl.departments.removeAt(oldIndex);
                                  ctrl.departments.insert(newIndex, item);
                                },
                                itemBuilder: (final context, final index) => WVoipDepartmentCard(
