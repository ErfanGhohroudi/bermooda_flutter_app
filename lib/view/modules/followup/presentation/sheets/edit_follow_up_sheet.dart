...
import '../controllers/edit_follow_up_controller.dart';

class EditFollowUpSheet extends StatefulWidget {
  const EditFollowUpSheet({
    required this.model,
  ...
  @override
  State<EditFollowUpSheet> createState() => _EditFollowUpSheetState();
}

class _EditFollowUpSheetState extends State<EditFollowUpSheet> with EditFollowUpController {
  @override
  void initState() {
