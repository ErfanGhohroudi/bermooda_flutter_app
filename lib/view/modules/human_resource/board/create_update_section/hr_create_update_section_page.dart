...
import 'hr_create_update_section_controller.dart';

class HRCreateUpdateSectionPage extends StatefulWidget {
  const HRCreateUpdateSectionPage({
  ...
  final Section<HRSectionReadDto, BoardMemberReadDto>? section;

  @override
  State<HRCreateUpdateSectionPage> createState() => _HRCreateUpdateSectionPageState();
}

class _HRCreateUpdateSectionPageState extends State<HRCreateUpdateSectionPage> with HRCreateUpdateSectionController {
  @override
  void initState() {
