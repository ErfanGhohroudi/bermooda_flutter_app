...
class SupportDepartmentCreateUpdatePage extends StatefulWidget {
  const SupportDepartmentCreateUpdatePage({
    required this.ctrl,
    this.department,
    super.key,
  });
  ...
  @override
  State<SupportDepartmentCreateUpdatePage> createState() => _SupportDepartmentCreateUpdatePageState();
}

class _SupportDepartmentCreateUpdatePageState extends State<SupportDepartmentCreateUpdatePage> {
  ...
  SupportDepartmentListController get ctrl => widget.ctrl;
      ...
      child: Column(
        ...
        children: [
          ...
          WMembersPickerFormField(
            ...
            filterByPermissionName: PermissionName.support,
            showSelf: true,
