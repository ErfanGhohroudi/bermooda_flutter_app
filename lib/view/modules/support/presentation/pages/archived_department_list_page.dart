...
class SupportArchivedDepartmentListPage extends StatefulWidget {
  const SupportArchivedDepartmentListPage({super.key});

  @override
  State<SupportArchivedDepartmentListPage> createState() => _SupportArchivedDepartmentListPageState();
}

class _SupportArchivedDepartmentListPageState extends State<SupportArchivedDepartmentListPage> {
  final SupportArchivedDepartmentListController ctrl = Get.put(SupportArchivedDepartmentListController());
