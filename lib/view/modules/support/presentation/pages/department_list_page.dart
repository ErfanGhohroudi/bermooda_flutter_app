...
class SupportDepartmentListPage extends StatefulWidget {
  const SupportDepartmentListPage({super.key});

  @override
  State<SupportDepartmentListPage> createState() => _SupportDepartmentListPageState();
}

class _SupportDepartmentListPageState extends State<SupportDepartmentListPage> {
  final SupportDepartmentListController ctrl = Get.put(SupportDepartmentListController());
      ...
      child: UScaffold(
        ...
        floatingActionButton: ctrl.haveAdminAccess
            ? FloatingActionButton(
                heroTag: "supportDepartmentsFAB",
                tooltip: s.newDepartment,
                onPressed: () {
                  bottomSheet(
                    title: s.newDepartment,
                    child: SupportDepartmentCreateUpdatePage(ctrl: ctrl),
                  );
                },
                            ...
                            SliverPadding(
                              ...
                              sliver: SliverReorderableList(
                                ...
                                onReorder: (final oldIndex, newIndex) {
                                  ...
                                  final SupportDepartment item = ctrl.departments.removeAt(oldIndex);
                                  ctrl.departments.insert(newIndex, item);
                                },
                                itemBuilder: (final context, final index) => WSupportDepartmentCard(
