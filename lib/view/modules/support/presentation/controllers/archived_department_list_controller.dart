...
import '../../domain/usecases/get_archived_support_departments.dart';
import '../../domain/usecases/restore_support_department.dart';
import 'department_list_controller.dart';

class SupportArchivedDepartmentListController extends GetxController {
  final SupportDepartmentRepositoryImpl _repository = SupportDepartmentRepositoryImpl();

  late final GetArchivedSupportDepartmentsUseCase _getArchivedDepartmentsUseCase = GetArchivedSupportDepartmentsUseCase(_repository);
  late final RestoreSupportDepartmentUseCase _restoreDepartmentUseCase = RestoreSupportDepartmentUseCase(_repository);
  ...
  void restoreDepartment(final SupportDepartment department) {
      ...
      onYesButtonTap: () async {
        ...
        try {
          ...
          if (Get.isRegistered<SupportDepartmentListController>()) {
            Get.find<SupportDepartmentListController>().onRefresh();
          }
        } catch (e) {
